 ...
 */
export const SeriesNavigation = React.memo(function SeriesNavigation({ seriesName, posts }: SeriesNavigationProps) {
  const currentIndex = posts.findIndex((p) => p.isCurrent);
