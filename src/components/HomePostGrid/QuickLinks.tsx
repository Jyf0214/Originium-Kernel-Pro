    ...
    <section className="mb-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/posts" className="group">
          <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200/60 dark:border-zinc-700/60 p-8 hover:border-zinc-400 dark:hover:border-zinc-500 hover:shadow-lg transition-all duration-300">
            ...
            <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-1">{t('nav.posts')}</h2>
        ...
        {isAdmin && (
          <Link href="/faces" className="group">
            <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200/60 dark:border-zinc-700/60 p-8 hover:border-zinc-400 dark:hover:border-zinc-500 hover:shadow-lg transition-all duration-300">
              ...
              <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-1">{t('nav.faces')}</h2>
              <p className="text-zinc-400 dark:text-zinc-500 text-sm">
