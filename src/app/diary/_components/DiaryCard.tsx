...
export function DiaryCard({
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-100 dark:border-zinc-700 overflow-hidden">
      <div
        className="p-4 sm:p-6 cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"
      ...
      >
        <div className="flex items-start justify-between gap-3 sm:gap-4">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-zinc-400 dark:text-zinc-500">
      ...
      {isViewing && (
        <div className="border-t border-zinc-100 dark:border-zinc-700 px-4 sm:px-6 py-4 sm:py-5">
          {viewLoading ? (
            <div className="flex items-center justify-center py-6 sm:py-8">
              <Loader2 size={20} className="sm:size-6 text-zinc-300 dark:text-zinc-600 animate-spin" />
            </div>
          ) : (
            <>
