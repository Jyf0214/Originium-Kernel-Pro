              ...
              >
                <div className="px-5 py-4 flex-1 flex flex-col">
                  ...
                  <Link href={`/posts${post.slug}`} className="block group/title">
                    <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-2 line-clamp-2 leading-snug group-hover/title:text-zinc-600 transition-colors duration-200">
                      {post.meta.title}
                    </h2>
                  </Link>
                  ...
                  {post.meta.description && (
                    <p className="text-zinc-400 dark:text-zinc-500 text-sm line-clamp-2 mb-3 leading-relaxed">
                      {post.meta.description}
                    </p>
                  )}
