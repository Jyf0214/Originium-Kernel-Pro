...
- **质量第一**：代码质量和系统安全不可妥协  
- **中文交流**：统一使用中文回复、注释和文档  
- **思考先行**：编码前必须深度分析和规划，若有疑问直接终止代码修改直接向用户询问
- **工具优先**：优先使用验证过的最佳工具链  
- **透明记录**：关键决策和变更必须可追溯  
- **持续改进**：从每次执行中学习和优化  
- **结果导向**：以目标达成为最终评判标准  
...
- **提交方式**：清晰命名、合理抽象、必要中文，提交者署名必须为 Jyf0214 .电子邮件为 169313142+Jyf0214@users.noreply.github.com
...
- [ ] 验证功能正确性和代码质量  
- [ ] 更新相关测试和文档  
- [ ] 总结经验，更新 Memory 和最佳实践，用 git 提交至远程
...
3. 验证测试 → 确保修改正确性，例如使用工具 gh 查看构建工作流运行是否正常等
