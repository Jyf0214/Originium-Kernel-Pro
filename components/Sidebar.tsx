...
export function Sidebar() {
  ...
  const links = [
    ...
    { href: '/dashboard/requests', label: t('sidebar.requests'), icon: ShieldAlert, roles: ['admin', 'sudo'] },
    { href: '/dashboard/config', label: t('sidebar.systemConfig'), icon: Settings, roles: ['admin', 'sudo'] },
    { href: '/dashboard/env', label: t('sidebar.envVariables'), icon: Globe, roles: ['admin', 'sudo'] },
    { href: '/dashboard/apikeys', label: t('sidebar.apiKeys') || 'API 密钥', icon: Key, roles: ['admin', 'sudo'] },
  ];
